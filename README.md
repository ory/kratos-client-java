...
Ory Kratos API
- API version: v0.6.0-alpha.13
  - Build date: 2021-05-10T15:51:24.932872Z[Etc/UTC]
...
<dependency>
  ...
  <version>v0.6.0-alpha.13</version>
  <scope>compile</scope>
</dependency>
```
...
```groovy
compile "sh.ory.kratos:kratos-client:v0.6.0-alpha.13"
```
...
* `target/kratos-client-v0.6.0-alpha.13.jar`
* `target/lib/*.jar`
