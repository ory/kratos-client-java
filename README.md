...
- API version: v0.6.0-alpha.16
  - Build date: 2021-05-10T17:53:00.313337614Z[Etc/UTC]
...
<dependency>
  ...
  <version>v0.6.0-alpha.16</version>
  <scope>compile</scope>
</dependency>
```
...
```groovy
compile "sh.ory.kratos:kratos-client:v0.6.0-alpha.16"
```
...
* `target/kratos-client-v0.6.0-alpha.16.jar`
* `target/lib/*.jar`
