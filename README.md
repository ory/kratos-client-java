...
Ory Kratos API
- API version: v0.6.0-alpha.12
  - Build date: 2021-05-10T15:38:46.869759Z[Etc/UTC]
...
<dependency>
  ...
  <version>v0.6.0-alpha.12</version>
  <scope>compile</scope>
</dependency>
```
...
```groovy
compile "sh.ory.kratos:kratos-client:v0.6.0-alpha.12"
```
...
* `target/kratos-client-v0.6.0-alpha.12.jar`
* `target/lib/*.jar`
