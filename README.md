...
Ory Kratos API
- API version: v0.6.0-alpha.9
  - Build date: 2021-05-10T13:51:56.185367Z[Etc/UTC]
...
<dependency>
  ...
  <version>v0.6.0-alpha.9</version>
  <scope>compile</scope>
</dependency>
```
...
```groovy
compile "sh.ory.kratos:kratos-client:v0.6.0-alpha.9"
```
...
* `target/kratos-client-v0.6.0-alpha.9.jar`
* `target/lib/*.jar`
