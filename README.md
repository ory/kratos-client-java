...
- API version: v0.6.0-alpha.11
  - Build date: 2021-05-10T15:29:10.580700Z[Etc/UTC]
...
<dependency>
  ...
  <version>v0.6.0-alpha.11</version>
  <scope>compile</scope>
</dependency>
```
...
```groovy
compile "sh.ory.kratos:kratos-client:v0.6.0-alpha.11"
```
...
* `target/kratos-client-v0.6.0-alpha.11.jar`
* `target/lib/*.jar`
