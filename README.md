...
Ory Kratos API
- API version: v0.6.0-alpha.10
  - Build date: 2021-05-10T14:44:50.402860Z[Etc/UTC]
...
<dependency>
  ...
  <version>v0.6.0-alpha.10</version>
  <scope>compile</scope>
</dependency>
```
...
```groovy
compile "sh.ory.kratos:kratos-client:v0.6.0-alpha.10"
```
...
* `target/kratos-client-v0.6.0-alpha.10.jar`
* `target/lib/*.jar`
