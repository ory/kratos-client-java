...
# Contribute to Ory Ory Kratos Java Client<!-- omit in toc -->
...
1. Add a descriptive prefix to commits. This ensures a uniform commit history
   ...
   [Convential Commits configuration](https://github.com/ory/kratos-client-java/blob/master/.github/workflows/conventional_commits.yml)
